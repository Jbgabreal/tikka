        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex justify-start">
            <div className="bg-gray-800 rounded-2xl rounded-tl-none px-4 py-2 max-w-xs">
              <div className="flex items-center mb-1">
                ...
                <p className="text-xs text-gray-400">Chatta</p>
              </div>
              <p className="text-white">$BONK is currently trading at $0.00001997, up 1.8% in the last 24h with a market cap of $1.77B.</p>
          ...
          <div className="flex justify-start">
            <div className="bg-gray-800 rounded-2xl rounded-tl-none px-4 py-2 max-w-xs">
              ...
              <p className="text-white">Processing your swap of 1 SOL to ~8,453,966.4 BONK at market rate...</p>
